...
Generated: 2025-12-13 18:19:04 UTC
Upstream Commit: 605ea49d020608b95fd2851ebbb4e68695287eae
Current Commit: caefd3869470be78ba1b518bd70bb151dd15a79d

## Upstream Changes

* 605ea49d0 window: Use malloc_trim when idle after closing a tab
* 9fce38154 file-chooser: Replace newlines with GLib function
* 17cfde0ec file-chooser: Fix newline check compiler warning
* 7c01b3f40 directory: Cleanup asserts
* dfa16465a directory: Split notifying and work queue adding
* 14f1225b5 view-item: Harden prioritization item usage
* 47da569c7 application: Run type check in public functions
* f5fea596a general: Minor clarification cleanups
...
## Files Changed
 ...
 INSTALLATION.md                                    |   29 -
 README.md                                          |  173 +-
 build-aux/check-potfiles.sh                        |    2 +-
 build-aux/flatpak/org.gnome.Nautilus.json          |   14 +-
 build-aux/run-uncrustify.sh                        |    2 +-
 ...
 src/nautilus-directory.c                           |  607 +--
 src/nautilus-directory.h                           |    8 +-
 src/nautilus-enums.h                               |    5 +-
 src/nautilus-file-chooser.c                        |   19 +-
 ...
 src/nautilus-query-editor.c                        |   78 +-
 src/nautilus-query.c                               |   82 +-
 src/nautilus-query.h                               |   12 +-
 src/nautilus-search-directory.c                    |   87 +-
 src/nautilus-search-engine-localsearch.c           |   98 +-
 src/nautilus-search-engine-model.c                 |   20 +-
 src/nautilus-search-engine-recent.c                |   26 +-
 src/nautilus-search-engine-searchcache.c           |  348 --
 src/nautilus-search-engine-searchcache.h           |   24 -
 src/nautilus-search-engine-simple.c                |  283 +-
 ...
 test/file-torture.py                               |    4 +-
 test/meson.build                                   |    1 -
 137 files changed, 15666 insertions(+), 15684 deletions(-)
